package com.hxl.pauserecord1.activity;
...
import com.hxl.pauserecord1.R;
import com.hxl.pauserecord1.record.AudioRecorder;
                ...
                try {
                    if (audioRecorder.getStatus() == AudioRecorder.Status.STATUS_NO_READY) {
                        ...
                        if(playername=="chirpa") {
                            player = MediaPlayer.create(this, R.raw.chirpa);
                        }
                        ...
                        if(playername=="twentymulticos") {
                            player = MediaPlayer.create(this, R.raw.twentymulticos);
                        }
                        if(playername=="ultragesture"){
                            player = MediaPlayer.create(this,R.raw.ultragesture);
                        }
...
//        MediaPlayer player =  MediaPlayer.create(this,R.raw.test);
            ...
            case R.id.button_timer:
                ...
                t.schedule(mytaskstart,5000,7000);
                break;
        }
    }
